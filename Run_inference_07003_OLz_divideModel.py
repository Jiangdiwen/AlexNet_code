from Model.CameraRegressor import CameraParamRegressor_1, CombinedModel, CameraParamRegressor_4, AlexNet_Regressor_Z,AlexNetFeatures
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        images = images.to(device)  # 将测试数据转移到设备上

        features = Z_feature_extraction(images)           
        test_outputs = Z_regressor_model(features)
   ...
   #print(f'start-end_time: {end_time - start_time0}')
    ...
    #np.save('/home/jyx/Jiangyanxin/Reg_DSA/AlexNet_Regression_Model/data/Predict_datas/0915_predict_OLZ_diviModel_07003DSA58.npy', output_list)
