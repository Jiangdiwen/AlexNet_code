...
Date: 2023-09-11 19:54:01
LastEditors: error: error: git config user.name & please set dead value or install git && error: git config user.email & please set dead value or install git & please set dead value or install git
LastEditTime: 2023-09-11 19:54:09
FilePath: \code\Dataloader\dataloader_Angle_PreZ.py
...
def load_npydata(Proj_data_path):
    ...
    for data in loaded_data:
        ...
        #vector_data = np.concatenate((rotation_angles))
        train_data_vectors.append(rotation_angles)
        #train_data_vectors.append(rotation_angles)
