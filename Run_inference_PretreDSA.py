...
LastEditTime: 2023-09-14 10:23:32
FilePath: /code/Run_inference_PretreDSA.py
Description: 这是默认设置,请设置`customMade`, 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
'''
from Model.CameraRegressor import CameraParamRegressor_7, CombinedModel
...
if __name__ == "__main__":
    ...
    regressor_model = CameraParamRegressor_7(input_size=256*6*6).float()
    combined_model = CombinedModel(alexnet_features, regressor_model)
    base_path = "/home/jyx/Jiangyanxin/Reg_DSA/AlexNet_Projects/08-18_Task_Split_lr1e-05_64batch_3000epochs_3485trainDatas"
    ...
    np.save('/home/jyx/Jiangyanxin/Reg_DSA/AlexNet_Regression_Model/data/Predict_datas/0821_SplitPredict_Pretre2_22DSA.npy', output_list)
    cc = 1
