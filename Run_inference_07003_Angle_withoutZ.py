...
LastEditTime: 2023-09-18 18:02:37
...
if __name__ == "__main__":
    ...
    regressor_model = CameraParamRegressor_3(input_size=256 * 6 * 6).float()
    base_path = "/home/jyx/Jiangyanxin/Reg_DSA/AlexNet_Projects/09-18_Task_Angle_withoutZ_07003lr_features1e-05_lr_regressor1e-05_64batch_1500epochs_5049trainDatas"
    ...
    with torch.no_grad():
        for iter in range(iterations):
            ...
            test_outputs = regressor_model(features)
   ...
   #print(f'start-end_time: {end_time - start_time0}')
    ...
    np.save('/home/jyx/Jiangyanxin/Reg_DSA/AlexNet_Regression_Model/data/Predict_datas/0918_predict_Angle_withoutZ_lr1e-05_07003_DSA58.npy', output_list)
