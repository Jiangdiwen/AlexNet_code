...
LastEditTime: 2023-08-18 15:42:26
Description: 
...
# from Dataloader.dataloader_divided import 
...
if __name__ == '__main__':
    ...
    # 创建回归模型实例
    num_params = 6
    regressor_model = CameraParamRegressor(input_size=feat_size[0] * feat_size[1] * feat_size[2], output_size=num_params).float()
    # ----------------------Task_parameters---------------------------------
    #num_epochs = 1500 
    num_epochs = 9999 
    num_Task = '_NosigmoChangeAngle'
