...
LastEditTime: 2023-09-17 00:34:26
Description: 
...
if __name__ == '__main__':
    ...
    regressor_model = CameraParamRegressor_3withZ_axis(input_size=feat_size[0] * feat_size[1] * feat_size[2]).float()
    # ----------------------Task_parameters---------------------------------
    #num_epochs = 1500 
    num_epochs = 1500
    ...
    for epoch in range(num_epochs):
        ...
        for images, labels in tqdm(train_loader, desc=f"Epoch {epoch + 1}/{num_epochs}", leave=False):
            ...
            outputs = regressor_model(combined_features)
        ...
        with torch.no_grad():
            for images, labels in val_loader:
                ...
                vali_outputs = regressor_model(vali_combined_features)
